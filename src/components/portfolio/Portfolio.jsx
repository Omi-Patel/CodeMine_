...
const Portfolio = () => {
  ...
  return (
    <div className="h-full bg-gradient-to-l from-[#0B0C10] to-[#1F2833]">
      ...
      {/* testimonial */}
      <div className="border-2">
        <section class="text-gray-600 body-font mx-8">
          <div class="container px-5 py-24 mx-auto">
            <h1 class="text-3xl font-medium title-font text-gray-100 mb-12 text-center">
              Testimonials
            </h1>
            <div class="flex flex-wrap -m-4 ">
              <div class="p-4 md:w-1/2 w-full">
                <div class="h-full bg-[#313131] p-8 rounded">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="currentColor"
                ...
                <div class="h-full bg-[#313131] p-8 rounded">
                  ...
                  <a class="inline-flex items-center">
                    ...
                    <span class="flex-grow flex flex-col pl-4">
                      ...
                      <span class="text-gray-400 text-sm">Softwar Er.</span>
                    </span>
                  </a>
                </div>
              </div>
